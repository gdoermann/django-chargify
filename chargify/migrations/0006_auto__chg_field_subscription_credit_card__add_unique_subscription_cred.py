...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Subscription.credit_card'
        db.alter_column('chargify_subscription', 'credit_card_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, null=True, to=orm['chargify.CreditCard']))

        # Adding unique constraint on 'Subscription', fields ['credit_card']
        db.create_unique('chargify_subscription', ['credit_card_id'])


    def backwards(self, orm):
        
        # Changing field 'Subscription.credit_card'
        db.alter_column('chargify_subscription', 'credit_card_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['chargify.CreditCard']))

        # Removing unique constraint on 'Subscription', fields ['credit_card']
        db.delete_unique('chargify_subscription', ['credit_card_id'])
