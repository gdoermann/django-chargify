...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CreditCard.first_name'
        db.add_column('chargify_creditcard', 'first_name', self.gf('django.db.models.fields.CharField')(max_length=50, null=True), keep_default=False)

        # Adding field 'CreditCard.last_name'
        db.add_column('chargify_creditcard', 'last_name', self.gf('django.db.models.fields.CharField')(max_length=50, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'CreditCard.first_name'
        db.delete_column('chargify_creditcard', 'first_name')

        # Deleting field 'CreditCard.last_name'
        db.delete_column('chargify_creditcard', 'last_name')
