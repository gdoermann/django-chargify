...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Customer._email'
        db.add_column('chargify_customer', '_email', self.gf('django.db.models.fields.EmailField')(max_length=75, null=True), keep_default=False)

        # Adding field 'Customer._first_name'
        db.add_column('chargify_customer', '_first_name', self.gf('django.db.models.fields.CharField')(max_length=50, null=True), keep_default=False)

        # Adding field 'Customer._last_name'
        db.add_column('chargify_customer', '_last_name', self.gf('django.db.models.fields.CharField')(max_length=50, null=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Customer._email'
        db.delete_column('chargify_customer', '_email')

        # Deleting field 'Customer._first_name'
        db.delete_column('chargify_customer', '_first_name')

        # Deleting field 'Customer._last_name'
        db.delete_column('chargify_customer', '_last_name')
