...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Customer._reference'
        db.add_column('chargify_customer', '_reference', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Customer._reference'
        db.delete_column('chargify_customer', '_reference')
